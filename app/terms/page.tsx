  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6 mt-[10vw]">
      ...
      <section className="mb-6">
        ...
        <p>
          The content on SkillMantra LMS—including text, images, videos, and
          downloadable materials—is provided for educational purposes only. You
          may not reproduce, distribute, or modify our content without proper
          authorization.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          You must notify us immediately if you suspect any unauthorized use of
          your account.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          All trademarks, logos, and intellectual property displayed on
          SkillMantra LMS are the property of their respective owners.
        </p>
        <p>
      ...
      <section className="mb-6">
        ...
        <p>
          Do not engage in any unlawful, harmful, or disruptive behavior on our
          website.
        </p>
        <p>
          Do not attempt to hack, reverse engineer, or interfere with our
          systems.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          SkillMantra LMS may contain links to external websites. We are not
