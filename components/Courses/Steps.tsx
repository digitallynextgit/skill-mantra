...
const Steps: React.FC = () => {
    return (
        <main className="flex flex-col items-center bg-white py-[6vw]  px-[6vw] ">
            <h1 className="md:text-[4vw] tracking-tight text-[7vw] font-semibold text-blue-90 pb-[10px]">Program Cycle</h1>
            ...
            <Image src="/cycle.webp" alt="Steps"  width={1000} height={100} className="my-14 "/>
