    ...
    <div className="p-4  pt-16 relative bg-blue-90">
      ...
      <div className="flex md:flex-row flex-col gap-5 items-start justify-start pb-10 z-40">
        {services.map((service, index) => (
          <div
            key={index}
            className="text-blue-90 md:mx-24 rounded-2xl bg-white h-[50vh] flex-1 flex flex-col items-center justify-center px-[5vw] md:py-0 py-[4vw] overflow-hidden z-30"
          >
