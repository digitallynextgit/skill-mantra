        ...
        <section className=" flex justify-center pt-[100px] md:flex-row flex-col items-center px-[5vw] md:py-[5vw] py-[10vw] gap-32 bg-blue-90 overflow-hidden">
            ...
            <div className="">
                ...
                <div className="flex flex-col z-20">
                    {data5.sections.map((section, index) => (
                    ...
                    <div>
                        <Button asChild className="bg-[#FFC224] py-8 px-8 text-xl rounded-xl text-blue-90 flex justify-center items-center lg:w-[50%]">
                            <Link href="https://courses.skillmantra.in/login" className='text-center'>Join a Free DemoClass<br/>  & Kickstart Your Career!</Link>
                        </Button>
                    </div>
                </div>
                <div className="mt-8">
                    {data5.subsections.map((subsection, index) => (
