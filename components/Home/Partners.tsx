...
const Partners = () => {
    ...
    return (
        <section className='bg-blue-90  py-[5vw]'>
            ...
            <div className=" bg-white overflow-hidden  translate-y-[5vw] md:translate-y-0  z-50 ">
                <div className="flex flex-nowrap animate-scroll hover:animate-pause">
              
                    {[...partnersimg, ...partnersimg].map((partner, index) => (
                        <div key={index} className="flex justify-center  items-center w-1/2 sm:w-1/3 md:w-1/5 lg:w-1/6 p-1">
                            <Image
                                src={partner.image}
                                alt={partner.alt}
                                width={150}
