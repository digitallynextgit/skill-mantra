...
import { STATIC_OFFER_DETAILS } from "@/constants"; 
import Loader from "@/components/ui/Loader"; 

const formSchema = z.object({
    firstName: z.string().min(1, "First Name is required").regex(/^[A-Za-z]+$/, "Only alphabets are allowed"),
    lastName: z.string().min(1, "Last Name is required").regex(/^[A-Za-z]+$/, "Only alphabets are allowed"),
    phone: z.string().min(10, "Phone number must be at least 10 digits").regex(/^\d+$/, "Only numbers are allowed"),
    email: z.string().email("Invalid email address"),
    city: z.string().min(1, "City/State is required").regex(/^[A-Za-z\s]+$/, "Only alphabets are allowed"),
    country: z.string().min(1, "Country is required").regex(/^[A-Za-z\s]+$/, "Only alphabets are allowed"),
