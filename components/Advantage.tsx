...
const FeatureCard: FC<FeatureCardProps> = ({ title, description, icon: Icon }) => {
  return (
    <div className="p-6 bg-[#FFC224]  rounded-lg shadow-md md:rounded-xl flex flex-col items-start h-[30vh] justify-center ">
      <div className="">
...
const FeaturesSection: FC = () => {
  return (
    <section className="py-12 px-[10vw] md:px-8 lg:px-16 z-20 ">
